        ...
        <div>
            ...
            <form className="card-body">
                            ...
                            <div className="form-control">
                                ...
                                <input name="password" type="password" placeholder="your password" className="input input-bordered text-[#F3F3F3]
                                " required />
                                <label className="label">
                            ...
                            <div className="form-control mt-6">
                                <button className="btn text-white bg-[#403F3F]"></button>
                            </div>
